...
<script>
    setTimeout(()=>{
        window.Echo.channel('chat').listen('chatMessage', (e) => {
            if(e.data != ""){
                $('#notifications').append(`<div id="toast-success${e.id}" class=" flex items-center w-full max-w-xs p-2 min-w-72 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 mt-2" role="alert">
                ...
                <div class="text-sm font-bold pr-1 w-56 truncate">Srong Sokleap : 
